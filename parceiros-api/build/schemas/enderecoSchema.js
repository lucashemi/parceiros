...
const UF_1 = __importDefault(require("../enums/UF"));
const enderecoSchema = Yup.object().shape({
    ...
    uf: Yup.string().oneOf(Object.values(UF_1.default), "O campo UF deve ter uma unidade federativa válida").required("O campo UF é obrigatório"),
});
